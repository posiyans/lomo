<template>
  <div class="q-pa-md">
    ...
    <div class="filter-container">
      ...
      <el-button class="filter-container__item" type="primary" @click="showReestr">
        Показать
      </el-button>
      <el-button class="filter-container__item" type="success" @click="downloadDialogVisible = !downloadDialogVisible">
        Скачать
      </el-button>
    ...
    >
      ...
      <div class="pt3">
        При загрузке большого диапазона, создание файла может занять некоторое<br> временя, так что наберитесь терпения!
      </div>
      <div>
...
import { fetchReceiptTypeList, getReceiptForSteadList, getReceiptList } from 'src/Modules/Receipt/api/receiptAdminApi.js'
