...
<script>
import { fetchAppelList, updateAppel } from 'src/Modules/Appeal/api/appeal-admin-api.js'
...
export default {
  ...
  methods: {
    ...
    handleShow(row) {
      ...
      this.dialogFormVisible = true
      this.$nextTick(() => {
        this.$ref.dataForm.clearValidate()
      })
    },
    updateData() {
      const data = {
