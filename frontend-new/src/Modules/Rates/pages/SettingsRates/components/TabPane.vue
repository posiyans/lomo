<template>
  <div>
    <div class="filter-container">
      <el-button class="filter-item" size="small" type="success" plain icon="el-icon-setting" @click="showSettings =! showSettings">
        Настройка
      </el-button>
      <el-button class="filter-item" size="small" type="success" plain icon="el-icon-circle-plus-outline" @click="addRateType">
        Добавить
      </el-button>
    </div>
    ...
    <el-table :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column class-name="status-col" label="Status" width="140">
        <template #default="{row}">
          <el-tag :type="statusFilter(row.enable)">
    ...
    <el-dialog v-model="dialogVisible" :title="edit ? 'Редактирование' : 'Добавить'">
...
<script>
import { createRate, fetchList, updateRate } from 'src/Modules/Rates/api/rate-admin-api.js'
