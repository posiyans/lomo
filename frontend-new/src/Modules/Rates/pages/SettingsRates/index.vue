<template>
  <div class="q-pa-md">
    <div class="filter-container">
      ...
      <el-button class="filter-item" size="small" type="primary" icon="el-icon-circle-plus-outline" @click="addReceipt">
        Добавить
      </el-button>
    </div>
...
import { createReceiptType, fetchReceiptTypeList } from 'src/Modules/Receipt/api/receiptAdminApi.js'
