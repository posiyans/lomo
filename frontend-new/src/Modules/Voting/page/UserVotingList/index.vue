<template>
  <div>
    <div class="text-h6 q-pa-sm">Голосования</div>
    ...
    <LoadMorePagination :key="key" v-model:list-query="listQuery" :func="func" @setList="setList" />
  </div>
</template>
...
import LoadMorePagination from 'src/components/LoadMorePagination/index.vue'
