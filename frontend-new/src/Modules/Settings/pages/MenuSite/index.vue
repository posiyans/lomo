<template>
  <div class="q-pa-md">
    ...
    <div v-else style="padding-left: 40px; background-color: antiquewhite">
      ...
      >
        ...
        <span class="custom-tree-node">
          <span :class="colorFilter(data.show_menu)">{{ node.label }}</span>
          <span>
            <el-button
              type="text"
              size="mini"
    ...
    <el-dialog title="Редактировать" v-model="dialogVisible">
...
<script>
import { createCategory, fetchCategoryList, updateCategory } from 'src/Modules/Article/Category/api/category.js'
