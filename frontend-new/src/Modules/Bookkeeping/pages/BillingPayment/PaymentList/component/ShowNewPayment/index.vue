<template>
  <div class="app-container">
      ...
      >
        ...
        >
          <template #default="{ row }">
            <ShowTime :time="row.payment_date" format="DD-MM-YYYY HH:mm" />
          </template>
        </el-table-column>
        <el-table-column
          label="Сумма"
        ...
        >
          <template #default="{row}">
            ...
            <div v-else>
              ...
              <el-dropdown @click="dropClick(row)" @command="setType">
    ...
    <div v-if="dialogMeterReadingFormVisible">
      <el-dialog title="Введите показания" v-model="dialogMeterReadingFormVisible">
        <div class="">{{ editRow.val7 }}</div>
...
export default {
  ...
  // name: 'ArticleDetail',
  components: { UserSteadFind, ShowTime },
  props: {
    list: {
      type: Array,
      default: () => ([])
