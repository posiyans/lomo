...
<script>
import { fetchDevicesForStead } from 'src/Modules/Bookkeeping/api/meteringDeviceAdminApi.js'
import { addInstrumentReadings } from 'src/Modules/Bookkeeping/api/communalAdminApi.js'
