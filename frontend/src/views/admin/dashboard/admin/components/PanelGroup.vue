<template>
  <el-row :gutter="40" class="panel-group">
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('user')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="countUser" :duration="1500" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('appel')">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('voting')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="countVoting" :duration="3200" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('stead')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="countStead" :duration="3600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
  </el-row>
...
export default {
  ...
  methods: {
    ...
    getVoting() {
      fetchVotingList().then(response => {
        this.countVoting = response.data.meta.total
      })
    },
    getAppels() {
